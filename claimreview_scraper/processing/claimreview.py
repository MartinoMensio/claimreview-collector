...
def retrieve_claimreview(url):
    ...
    if not result:
        ...
        if sharethefacts_ids:
            if domain in ['politifact.com','factcheck.org','washingtonpost.com','afp.com','tempo.co','pagellapolitica.it', 'demagog.org.pl', 'poynter.org', 'liberation.fr', 'verafiles.org']:
