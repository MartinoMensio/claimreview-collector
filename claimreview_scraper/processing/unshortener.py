...
shortening_domains = [
    ...
    'go2l.ink',
    # others
    'lnkd.in','cnn.it','strw.rs','nyer.cm','bloom.bg','n.pr','soc.li',
    'wndw.ms','amzn.com','gph.is','cs.pn','fb.me','cbr.st','nzzl.us','wp.me','spr.ly','spoti.fi','g.co',
    'ht.ly','rol.st','rewirenews.link','cwrld.us','urbn.is','ebks.to','wrld.bg','igg.me','theatln.tc','jrnl.ie',
    'go.shr.lc','huff.to','hvrd.me','trib.al','usaa.us','instagr.am','bzfd.it','edwk.it','interc.pt','po.st','nyti.ms',
    'wamu.fm','t.co','bos.gl','dailyre.co','sie.ag','shrtm.nu','econ.st','capi.tl','cbc.ca','wrd.cm','kck.st','wapo.st',
    'imdb.me','ln.is','reut.rs','wired.trib.al','pw-ne.ws','washex.am','chroni.cl','rviv.ly','intel.ly',
    'nbcnews.to','detne.ws','is.gd','dx.doi.org','nyr.kr','bonap.it',
    'snpy.tv','brook.gs','amzn.to', 'amn.st', 'ind.pn',
    'jwatch.us','thesco.re', 'mnky.in', 'lat.ms','ift.tt',
    'hill.cm','gop.cm','wbur.fm', 'pwne.ws', 'thetim.es',
    'ti.me','scim.ag','thkpr.gs','shortyw.in','tak.pt',
    'di.sn','cbsn.ws', 'dailym.ai', 'engt.co','bbc.in',
    'oxford.ly','cfp.cc', 'hub.am', 'oe.cd', 'lapl.me','chn.ge',
    'aclj.us','chng.it', 'vult.re','huffp.st','awe.sm', 'yhoo.it'
    'disq.us','fxn.ws', 'on.fb.me','twb.ly','mailchi.mp', 'youtu.be',
    'db.tt','conta.cc','deck.ly','smarturl.it', 'virl.io','ubm.io','usat.ly',
    'bit.ly','thedo.do','soa.li','adf.ly','shar.es','drudge.tw','thebea.st'
    'pin.it','wrld.at','owl.li', 'smithmag.co','jstor.info','fw.to','cjr.bz'
    'meetu.ps','abcn.ws', 'bit.do','poy.nu','shr.gs','etsy.me','tech.mg','edtru.st'
    'flip.it', 'tgr.ph','onforb.es','edut.to','redd.it','apple.co','apne.ws','cnb.cx', 'pens.pe'
    'wpo.st', 'bfpne.ws','slate.me','long.fm','ntrda.me','tmblr.co','cnet.co','flic.kr',
    'ow.ly','sco.lt','some.ly', 'bitly.com','atxne.ws','j.mp','dlvr.it', 'tcrn.ch','goo.gl',
]
