...
def test_add_claimreviews_raw():
    cr = {"url": "https://datacommons.org/factcheck/download#fcmt-data"}
...
def test_save_original_data():
    data = {"url": "https://datacommons.org/factcheck/download#fcmt-data"}
...
def test_get_all_factchecking_urls():
    ...
    res = database_builder.get_all_factchecking_urls()
    assert len(list(res)) == 1
    cr = {"url": "https://datacommons.org/factcheck/download#fcmt-data2"}
